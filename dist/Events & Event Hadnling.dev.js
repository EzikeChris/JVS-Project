...
document.querySelector('.btn-roll').addEventListener(); // Call back function
// a function that is called by another function eg through the event listener

function btn() {}

btn();
document.querySelector('.btn-roll').addEventListener('click', btn); // a function not called by the dev, but by another function is called the call back function as above, a function that is passed into another function as an argument
