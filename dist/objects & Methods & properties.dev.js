...
console.log(chris); // to find an element inside an object e.g firstName you make use of (dot Notation).firstName or .birthYear in the console

console.log(chris.birthYear); // another way is to use brakcets like an array 

console.log(chris['firstName']); // alternatively using a variable lets say x 

var x = 'lastName';
console.log(chris[x]); // adding data to your objects like arrays 

john.job = 'logistics';
john['isMarried'] = true;
console.log(john); // new object syntax

var mercy = new object();
mercy.firstName = 'mercy';
mercy.birthYear = 1960;
mercy['lastName'] = 'Niang';
console.log(mercy); // object Methods 
...
console.log(chris.calcAge(1993)); // objects has a basic key called this. which points to itself
...
console.log(chris.calcAge(1993)); // Contructor
